  ...
  for(int i =0; i <EntityProduct.size(); i++ ){ 
     ...
     String SKU  = EntityProduct.get(i).getSKU();
      String name = EntityProduct.get(i).getName();
       ...
       <% out.println("<td><a href='#'onMouseOver='ShowPicture('imgURL',1)' onMouseOut='ShowPicture('imgURL',0)'>image</a></td>");%>
       <% out.println("<div id='imgURL'><img src='https://i.ibb.co/PC5Ggnj/3e34ac2cf62f0059c0412504fb44cf2.jpg'></div>");%>     
